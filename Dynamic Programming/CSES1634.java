...
public class CSES1634 {
    ...
    // DP[x] = Minimum coins to sum x
    
    /* Base cases
       1) DP[x] = 1 if x is present in coins[]
       2) DP[0] = 0 (No coin is required for sum = 0)
    */
    ...
    */
    ...
    public static void main(String[] args)throws Exception {
        if(memory) new Thread(null, new Runnable() {public void run(){try{new CSES1634().run();}catch(Exception e){e.printStackTrace();System.exit(1);}}}, "", 1 << 28).start();
        else new CSES1634().run();
    }
